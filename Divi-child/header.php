...
?>
	...
	<?php ob_start(); ?>
		<header id="main-header" class="psy_header" data-height-onload="<?php echo esc_attr( et_get_option( 'menu_height', '66' ) ); ?>">
			...
			?>
                <div class="header_elements">
                    <div class="left_side">
                        ...
                        <?php if (!empty(get_theme_mod('description'))) { ?>
                        <span>  <?php echo get_theme_mod('description'); ?></span>
                        <?php } ?>
                    </div>
                    <div class="right_side">
                        <?php if (!empty(get_theme_mod('free_phone'))) { ?>
                        <span>  <?php echo get_theme_mod('free_phone'); ?></span>
                        <?php } ?>
                        <?php if (!empty(get_theme_mod('phone'))) { ?>
			...
			?>
				<div id="et-top-navigation" class="header_menu" data-height="<?php echo esc_attr( et_get_option( 'menu_height', '66' ) ); ?>" data-fixed-height="<?php echo esc_attr( et_get_option( 'minimized_menu_height', '40' ) ); ?>">
					<?php if ( ! $et_slide_header || is_customize_preview() ) : ?>
						<nav id="top-menu-nav">
						<?php
							$menuClass = 'nav';
