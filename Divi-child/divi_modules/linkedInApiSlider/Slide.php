...
class ET_Builder_Module_Slide extends ET_Builder_Module {
    function init() {
        $this->name                        = esc_html__( 'Slide', 'et_builder' );
        $this->plural                      = esc_html__( 'Slides', 'et_builder' );
        $this->slug                        = 'et_pb_li_api_slide_02';
        $this->vb_support                  = 'off';
        $this->type                        = 'child';
        ...
        $this->advanced_fields = array(
            'fonts'                 => array(
                'header' => array(
                    ...
                    'css'      => array(
                        'main' => ".et_pb_linkedin_slider {$this->main_css_element}.et_pb_li_api_slide .et_pb_slide_description .et_pb_slide_title",
                        'limited_main' => ".et_pb_linkedin_slider {$this->main_css_element}.et_pb_li_api_slide .et_pb_slide_description .et_pb_slide_title, .et_pb_linkedin_slider {$this->main_css_element}.et_pb_li_api_slide .et_pb_slide_description .et_pb_slide_title a",
                        'important' => 'all',
                    ),
                    'line_height' => array(
                ...
                'body'   => array(
                    ...
                    'css'      => array(
                        'main'        => ".et_pb_linkedin_slider.et_pb_module {$this->main_css_element}.et_pb_li_api_slide .et_pb_slide_description .et_pb_slide_content",
            ...
            'button'                => array(
                'button' => array(
                    ...
                    'css'      => array(
                        'main' => ".et_pb_linkedin_slider {$this->main_css_element}.et_pb_li_api_slide .et_pb_more_button.et_pb_button",
                        'limited_main' => ".et_pb_linkedin_slider {$this->main_css_element}.et_pb_li_api_slide .et_pb_more_button.et_pb_button",
                        'alignment' => ".et_pb_linkedin_slider {$this->main_css_element} .et_pb_slide_description .et_pb_button_wrapper",
                    ),
                    'use_alignment' => true,
                    'box_shadow' => array(
                        'css' => array(
            ...
            'background'            => array(
                'css' => array(
                    'main' => ".et_pb_linkedin_slider %%order_class%%",
                ),
                'options' => array(
            ...
            'margin_padding' => array(
                'use_margin' => false,
                'css' => array(
                    'padding'   => '.et_pb_linkedin_slider %%order_class%% .et_pb_slide_description, .et_pb_slider_fullwidth_off %%order_class%% .et_pb_slide_description',
            ...
            'text'                  => array(
                ...
                'css' => array(
                    ...
                    'text_orientation' => '.et_pb_slides %%order_class%%.et_pb_li_api_slide .et_pb_slide_description',
                    'text_shadow'      => '.et_pb_slides %%order_class%%.et_pb_li_api_slide .et_pb_slide_description',
                ),
                'options'              => array(
        ...
        $this->custom_css_fields = array(
            ...
            'slide_button' => array(
                ...
                'selector' => '.et_pb_li_api_slide .et_pb_container a.et_pb_more_button.et_pb_button',
    ...
    function get_fields() {
        $fields = array(
            'first_name'         => array(
                'label'           => esc_html__( 'Show First Name', 'et_builder' ),
                'type'            => 'yes_no_button',
                ...
                'default_on_front' => 'on',
                'toggle_slug'     => 'content',
                'description'     => esc_html__( 'This setting will show first name from linkedIn profile', 'et_builder' ),
            ),
            'last_name'         => array(
                'label'           => esc_html__( 'Show Last Name', 'et_builder' ),
                'type'            => 'yes_no_button',
                'option_category' => 'configuration',
                'options'         => array(
                    'on'  => esc_html__( 'Yes', 'et_builder' ),
                ...
                'default_on_front' => 'on',
                'toggle_slug'     => 'content',
                'description'     => esc_html__( 'This setting will show last name from linkedIn profile', 'et_builder' ),
            ),
            'id'         => array(
                'label'           => esc_html__( 'Show id', 'et_builder' ),
                'type'            => 'yes_no_button',
                'option_category' => 'configuration',
                'options'         => array(
                    'on'  => esc_html__( 'Yes', 'et_builder' ),
                ...
                'default_on_front' => 'on',
                'toggle_slug'     => 'content',
                'description'     => esc_html__( 'This setting will show id from linkedIn profile', 'et_builder' ),
            ),
            'heading' => array(
    ...
    function linked_in_api_curl_connect($api_url, $request = '', $content_type = '') {
        ...
        $headers = array(
            ...
            'Authorization: Bearer ' . get_option('linkedin_api_option')['access_token']
        );
    ...
    function get_linked_in_info() {
        $api_url = 'https://api.linkedin.com//v2/me';
        $result = $this->linked_in_api_curl_connect($api_url,'GET');
    ...
    function render( $attrs, $content = null, $render_slug ) {
        ...
        $id                              = $this->props['id'];
        $linkedin_info                   = $this->get_linked_in_info();
        ...
        if ( 'on' === $use_bg_overlay && '' !== $bg_overlay_color ) {
            ET_Builder_Element::set_style( $render_slug, array(
                'selector'    => '%%order_class%%.et_pb_li_api_slide .et_pb_slide_overlay_container',
                'declaration' => sprintf(
        ...
        if ( $is_text_overlay_applied && '' !== $text_overlay_color ) {
            ET_Builder_Element::set_style( $render_slug, array(
                'selector'    => '%%order_class%%.et_pb_li_api_slide .et_pb_text_overlay_wrapper',
                'declaration' => sprintf(
                    'background-color: %1$s;',
        ...
        // Module classnames
        $this->add_classname( 'et_pb_slide' );
        ...
        if ('on' === $first_name) {
            $fname = sprintf(
                '<div class="li_first_name">%1$s</div>',
                $linkedin_info->firstName->localized->ru_RU
            );
        }

        if ('on' === $last_name) {
            $lname = sprintf(
                '<div class="li_last_name">%1$s</div>',
                $linkedin_info->localizedLastName
            );
        }

        if ('on' === $id) {
            $lid = sprintf(
                '<div class="li_id">%1$s</div>',
                $linkedin_info->id
            );
        }
        ...
        $slide_content = sprintf(
            '%1$s
				<div class="et_pb_slide_content%3$s">%2$s%4$s%5$s%6$s</div>',
            et_core_esc_previously( $heading ),
            $this->content,
