...
class ET_Builder_Module_LinkedIn_Api_Slider extends ET_Builder_Module {
    function init() {
        $this->name            = esc_html__( 'LinkedIn Slider', 'et_builder' );
        $this->plural          = esc_html__( 'LinkedIn Sliders', 'et_builder' );
        $this->slug            = 'et_pb_linkedin_slider_02';
        $this->vb_support      = 'off';
        $this->child_slug      = 'et_pb_li_api_slide_02';
        $this->child_item_text = esc_html__( 'Slide', 'et_builder' );

        $this->main_css_element = '%%order_class%%.et_pb_linkedin_slider';
        ...
        $this->advanced_fields = array(
            ...
            'text'                  => array(
                'css'   => array(
                    'text_orientation' => '%%order_class%% .et_pb_li_api_slide .et_pb_slide_description',
                    'text_shadow'      => '%%order_class%% .et_pb_li_api_slide .et_pb_slide_description',
                ),
                'options' => array(
        ...
        $this->custom_css_fields = array(
            ...
            'slide_button' => array(
                ...
                'selector' => '.et_pb_linkedin_slider .et_pb_li_api_slide .et_pb_slide_description a.et_pb_more_button.et_pb_button',
    ...
    function render( $attrs, $content = null, $render_slug ) {
        ...
        if ( '' !== $background_position && 'default' !== $background_position  && 'off' === $parallax ) {
            ...
            ET_Builder_Module::set_style( $render_slug, array(
                'selector'    => '%%order_class%% .et_pb_li_api_slide',
                'declaration' => sprintf(
    ...
    private function inner_shadow_back_compatibility( $functions_name ) {
        ...
        version_compare( $utils->array_get( $atts, '_builder_version', '3.0.93' ), '3.0.99', 'lt' )
            ...
            $style = sprintf(
                '<style>%1$s</style>',
                sprintf(
                    '.%1$s.et_pb_linkedin_slider .et_pb_li_api_slide {'
...
new ET_Builder_Module_LinkedIn_Api_Slider;
